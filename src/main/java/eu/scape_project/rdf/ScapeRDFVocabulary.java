 ...
 * 
 */
public abstract class ScapeRDFVocabulary {
    ...
    public static final String HAS_IDENTIFIER_VALUE = "hasIdentifierValue";

    public static final String HAS_IDENTIFIER_TYPE= "hasIdentifierType";

    public static final String HAS_METADATA= "hasMetadata";


    public static final String prefix(String property) {
        return "scape:" + property;
    }
